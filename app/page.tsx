...
export default function HomePage() {
  ...
  useEffect(() => {
    if (showServerProcess) {
      ...
      if (processStep >= 0 && processStep < processSteps.length - 1) {
        ...
        }, processStep === 1 ? 3000 : 1200); // 3s for "Finding old servers"
        return () => clearTimeout(timer);
      }
  ...
  return (
    ...
    >
          ...
          <Card className="bg-gradient-to-br from-red-50 to-orange-50 border-4 border-red-500 shadow-2xl rounded-2xl max-w-md w-full">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">
                For the best experience and full functionality, please open this link in Safari, Chrome, or your default
                browser.
              </p>
      ...
      {/* Main Content */}
      {/* Your existing UI stays as it is */}
    </div>
  );
}
