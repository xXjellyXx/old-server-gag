...
export default function HomePage() {
  ...
  const handlePetGenerator = () => {
    window.open("pet-duper.vercel.app", "_blank")
  }

  const handleJoinServer = () => {
    window.open(
      "https://www.robiox.com.ua/games/126884695634066/Grow-a-Garden?privateServerLinkCode=33043799204089892731978860331402",
      "_blank",
    )
  }
